...
template <typename T> Linked_List<T>::Linked_List(const Linked_List& src) {
...
template <typename T> Linked_List<T>::Linked_List(Linked_List&& src) {
...
/*******************************************************************************
 GET FUNCTIONS FOR DATA STRUCTURE PROPERTIES
*******************************************************************************/
template <typename T> std::size_t Linked_List<T>::get_size() {
    return this->size;
}
...
template <typename T> void Linked_List<T>::insert(const T& data, std::size_t index) {
    ...
    if (((this->polar_left == nullptr) && (this->polar_right == nullptr)) && (index == 0)) {
...
template <typename T> void Linked_List<T>::remove() {
...
template <typename T> void Linked_List<T>::remove(std::size_t index) {
...
template <typename T> void Linked_List<T>::replace(T& data, std::size_t index) {
...
DATA STRUCTURE OPERATOR OVERLOADS
*******************************************************************************/
template <typename T> T& Linked_List<T>::operator [](std::size_t index) const {
    ...
    if (index == 0) {
        ...
        throw std::out_of_range("Tried to access data from an index higher than data was stored.");
    }

}

template <typename T> Linked_List<T>& Linked_List<T>::operator = (const Linked_List<T>& src) {
...
template <typename T> Linked_List<T>& Linked_List<T>::operator = (Linked_List<T>&& src) noexcept {
